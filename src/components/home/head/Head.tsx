...
function Head(): React.ReactElement {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full my-10">
            ...
            {pinataContext && !pinataContext?.account && <div className="w-full flex flex-col items-center justify-center mt-5">
                <p className="opacity-80">Connect your <span className="font-semibold text-orange-500">MetaMask</span> to view and upload files</p>
