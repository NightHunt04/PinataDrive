    ...
    return (
        <div className="flex flex-col items-center justify-center w-full my-10">
            ...
            {pinataContext && !pinataContext?.account && <div className="w-full flex flex-col items-center justify-center mt-10">
                <p className="w-[80%] text-center opacity-80">Connect your <span className="font-semibold text-orange-500">MetaMask</span> to view and upload files. Change network to Ethereum <span className='text-pink-500'>Sepolia</span> testnet of your wallet</p>
